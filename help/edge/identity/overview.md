...
Once the cookie containing the ECID has been set, each subsequent request generated by the Web SDK will include a base64 encoded ECID in the `kndctr_{YOUR-ORG-ID}_AdobeOrg_identity` cookie.
